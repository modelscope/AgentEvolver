...
log_file="logs/assignment/qwen3_14b_tsc_baseline_${current_time}.log"
...
python3 -m beyondagent.main_ppo \
    ...
    trainer.experiment_name="qwen3_14b_tsc_baseline" \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=20 \
    trainer.total_epochs=20 \
    trainer.val_before_train=True \
    trainer.validation_data_dir="experiments/exp_tsc_baseline${current_time}/validation_log" \
    trainer.rollout_data_dir="experiments/exp_tsc_baseline${current_time}/rollout_log" \
