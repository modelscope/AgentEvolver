#!/bin/bash
# Single-node GSPO training on AppWorld.
...
# 2) Run from anywhere:  bash /path/to/SeeUPO/launcher/qwen3_appworld/qwen3-gspo-appworld.sh
...
cd "${PROJECT_ROOT}"
exec python launcher.py --conf "${PROJECT_ROOT}/launcher/qwen3_appworld/qwen3-gspo-appworld.yaml"
